...
Before selecting **Submit for Review**, confirm that the publisher identity is verified as Adrián Melic, the public GitHub Pages URLs are live, the archive hash matches the local build output, and every test has been rerun with the final archive.
