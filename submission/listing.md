...
- Version 1.3.1 addresses seven automated-review findings with regression tests. Repeat the clean installed-plugin and Google Drive acceptance before publishing the hotfix.
