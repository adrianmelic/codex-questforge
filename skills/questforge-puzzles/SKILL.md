...
1. State the immediate situation and why it matters.
2. Remind the player of relevant clues naturally, not as an answer key.
3. Ask one concrete question.
4. Accept plausible reasoning; do not require exact phrasing.
5. If the player struggles, offer a hint that points to one prior clue.
6. After two wrong attempts, a hint request, or visible fatigue, use the
   fallback and keep play moving.
7. Record the result, reward, cost, and any new clue in campaign memory.
